				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" id="java" name="java"
								placeholder="자바점수" class="form-control" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" id="servlet" name="servlet"
								placeholder="서블릿" class="form-control" minlength="2" required>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" id="spring" name="spring"
								placeholder="spring" class="form-control" minlength="2" >
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							placeholder="보너스"
								class="form-control" minlength="2" required value="">
