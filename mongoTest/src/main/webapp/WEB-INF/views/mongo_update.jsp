				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dept" name="dept" placeholder="부서명"
							class="form-control" minlength="2" value="<%=dto.getDept() %>">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="addr" name="addr" placeholder="주소"
							class="form-control" minlength="2" required value="<%=dto.getAddr() %>">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="servlet" name="servlet" placeholder="서블릿"
							class="form-control" minlength="2" required value="<%=dto.getServlet() %>">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="bonus" name="bonus" placeholder="보너스"
							class="form-control" minlength="2" required value="10000">
