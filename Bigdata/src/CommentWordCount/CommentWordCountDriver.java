...
import CommentWordCount.CommentWordCountDriver;
import CommentWordCount.CommentWordCountMapper;
import CommentWordCount.CommentWordCountReducer;
...
public class CommentWordCountDriver {
	public static void main(String[] args)throws Exception {
		...
		Job job = new Job(conf, "comment_count");
